# This file contains constants used by the MachO file format
# The values of the constants have been taken from the appropriate
# header files on a Mac OS 10.9 system or the MachO reference documentation
